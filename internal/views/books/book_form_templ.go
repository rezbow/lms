...
func BookForm(book *models.Book, errors views.Errors, endpoint string, categories []models.Category) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if book != nil {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `books/book_form.templ`, Line: 25, Col: 24}
			}
		...
		if errors["title"] != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `books/book_form.templ`, Line: 29, Col: 29}
			}
		...
		if book != nil {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `books/book_form.templ`, Line: 41, Col: 23}
			}
		...
		if errors["isbn"] != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `books/book_form.templ`, Line: 45, Col: 28}
			}
		...
		if book != nil {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `books/book_form.templ`, Line: 57, Col: 30}
			}
		...
		if errors["totalCopies"] != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `books/book_form.templ`, Line: 61, Col: 35}
			}
		...
		if book != nil {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `books/book_form.templ`, Line: 73, Col: 27}
			}
		...
		if errors["authorId"] != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `books/book_form.templ`, Line: 77, Col: 32}
			}
		...
		if book != nil {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `books/book_form.templ`, Line: 90, Col: 28}
			}
		...
		if errors["publisher"] != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `books/book_form.templ`, Line: 94, Col: 33}
			}
		...
		if book != nil {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `books/book_form.templ`, Line: 105, Col: 27}
			}
		...
		if errors["language"] != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `books/book_form.templ`, Line: 109, Col: 32}
			}
		...
		if book != nil {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `books/book_form.templ`, Line: 120, Col: 29}
			}
		...
		if errors["translator"] != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `books/book_form.templ`, Line: 124, Col: 34}
			}
		...
		if book != nil {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `books/book_form.templ`, Line: 135, Col: 20}
			}
		...
		if errors["summary"] != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `books/book_form.templ`, Line: 139, Col: 31}
			}
		...
		for _, category := range categories {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `books/book_form.templ`, Line: 148, Col: 33}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `books/book_form.templ`, Line: 148, Col: 51}
			}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 61, "</select></section><section><label for=\"coverImage\">جلد کتاب</label> <input type=\"file\" name=\"coverImage\"> ")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if errors["coverImage"] != "" {
			...
			templ_7745c5c3_Var21, templ_7745c5c3_Err = templ.JoinStringErrs(errors["coverImage"])
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `books/book_form.templ`, Line: 158, Col: 34}
			}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 64, "</section><section>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if book != nil {
			...
			templ_7745c5c3_Var22, templ_7745c5c3_Err = templ.JoinStringErrs(book.CoverImageUrl)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `books/book_form.templ`, Line: 163, Col: 34}
			}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 67, "</section><section class=\"grid\"><input type=\"submit\" value=\"ثبت\"> <input type=\"reset\" value=\"بازنشانی\"></section></form>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if errors != nil {
			...
			for _, v := range errors {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `books/book_form.templ`, Line: 174, Col: 16}
				}
